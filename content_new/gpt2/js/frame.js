...
function setEventListener(){
	...
	document.getElementById("submitButton").addEventListener("click",function(e){
		...
		postData.link=document.getElementById('link').value;
		postData.link_title=document.getElementById('link_title').value;
		postData.imglink=document.getElementById('imglink').value;
		postData.summary=document.getElementById('summary').value;
