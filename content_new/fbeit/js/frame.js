...
function setEventListener(){
	...
	document.getElementById("submitButton").addEventListener("click",function(e){
		var postData = {};
		postData.name = "inviteFriendsToEvent";
		postData.id=document.getElementById("idInput").value;
		postData.delay=document.getElementById("delayTime").value;
		postData.starting_friend_number=document.getElementById("startingFriendNumber").value;
		postData.ending_friend_number=document.getElementById("endingFriendNumber").value;
		top.postMessage(postData, "*");
	});
}
function loaded(){
