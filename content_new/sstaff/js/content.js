...
params+='&message_batch[0][manual_retry_cnt]=0';
	...
	params += '&drp=1';
	*/
	params+='action_type=ma-type%3Auser-generated-message';
params+='&thread_id=';
params+='&author=fbid%3A'+encodeURIComponent(user_id);
params+='&author_email=';
params+='&timestamp=1459897395327';
params+='&timestamp_absolute=Today';
params+='&timestamp_relative=4%3A33am';
params+='&timestamp_time_passed=0';
params+='&is_unread=false';
params+='&is_forward=false';
params+='&is_filtered_content=false';
params+='&is_filtered_content_bh=false';
params+='&is_filtered_content_account=false';
params+='&is_filtered_content_quasar=false';
params+='&is_filtered_content_invalid_app=false';
params+='&is_spoof_warning=false';
params+='&source=source%3Achat%3Aweb';
params+='&source_tags[0]=source%3Achat';
params+='&body=';
params+='&has_attachment=true';
params+='&html_body=false';
params+='&specific_to_list[0]=fbid%3A'+encodeURIComponent(id);
params+='&specific_to_list[1]=fbid%3A'+encodeURIComponent(user_id);
params+='&ui_push_phase=V3';
params+='&sticker_id='+encodeURIComponent(stickerid);
params+='&status=0';
var mid=parseInt(Math.random()*1000000000000000000);
params+='&offline_threading_id='+mid;
params+='&message_id='+mid;
params+='&signatureID=31337a'+parseInt(Math.random()*100);
params+='&ephemeral_ttl_mode=0';
params+='&manual_retry_cnt=0';
params+='&other_user_fbid='+encodeURIComponent(id);
params+='&client=mercury';
params+='&__user='+ encodeURIComponent(user_id);
params+='&__a=1';
params+='&__req=x';
