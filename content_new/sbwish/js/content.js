...
function messagefriend(friendid, message, stickerid) {
	...
	xmlhttpunfriend.open("POST", "/messaging/send/", true);
...
params+="&author_email";
params+="&timestamp=1459899452787";
params+="&timestamp_absolute=Today";
params+="&timestamp_relative=5%3A07am";
params+="&timestamp_time_passed=0";
params+="&is_unread]=false&is_forward=false";
...
params+="&source=source%3Atitan%3Aweb";
params+="&body="+encodeURI(message);;
